    ...
    <div id="main-wrapper">
      ...
      <!-- container-form -->
        ...
        <div id="container-form">
          ...
          <s:if test="#session.checked">
            <div class="form-group">
              <label for="exampleInputEmail1">Eメールアドレス</label>
              	<s:textfield class="form-control txt" id="exampleInputEmail" name="email" value="%{#session.email}" label="メールアドレス" placeholder="メールアドレス" type="email" style="ime-mode: disabled;">
				</s:textfield>
              <small class="text-muted">あなたのメールは他の誰とも共有しません。</small>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">パスワード</label>
              <s:password class="form-control txt" id="exampleInputUserPassword"  name="userPassword"  value="%{#session.userPassword}" label="パスワード" placeholder="パスワード" ></s:password>
            </div>
            </s:if>
            ...
            <s:else>
             <div class="form-group">
              <label for="exampleInputEmail1">Eメールアドレス</label>
              	<s:textfield class="form-control txt" id="exampleInputEmail" name="email" value="" label="メールアドレス" placeholder="メールアドレス" type="email" style="ime-mode: disabled;">
				</s:textfield>
              <small class="text-muted">あなたのメールは他の誰とも共有しません。</small>
            </div>
            <div class="form-group">
...
<%--
            <s:iterator value="#session.checked"><s:property /><br></s:iterator> --%>
            ...
            <div class="form-group form-check">
              <s:checkbox  name="checked" value="#session.checked" ></s:checkbox>
