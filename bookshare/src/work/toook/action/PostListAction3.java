...
public class PostListAction3 extends ActionSupport implements SessionAware{
...
// 			最新10件の投稿を取得
 			postDetailList = postListDAO.returnPost3();
 			session.put("postDetailList3",postDetailList);
