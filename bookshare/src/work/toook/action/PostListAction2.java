...
public class PostListAction2 extends ActionSupport implements SessionAware{
	private Map<String, Object> session;
	private boolean loginFlg;
	private List<String> loginPostErrorMessageList = new ArrayList<String>();
	private List<PostListDTO> postDetailList = new ArrayList<PostListDTO>();
...
// 			最新10件の投稿を取得
 			postDetailList = postListDAO.returnPost2();
 			session.put("postDetailList2",postDetailList);
	...
	public List<PostListDTO> getPostDetailList() {
	...
	public void setPostDetailList1(List<PostListDTO> postDetailList) {
