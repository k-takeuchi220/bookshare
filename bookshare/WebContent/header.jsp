...
<head>
	...
	<script>
	function goPostListAction(){
		document.getElementById("form").action="PostListAction";
	}
	          ...
	          <div class="container">
	            ...
	            <div class="collapse navbar-collapse" id="menu">
	              <ul class="navbar-nav ml-auto" id="navbarRight">
	                <li class="nav-item">
	                   <a class="nav-link button" onclick='href="HomeAction#bookshareIntroduction"'  style="color:white;background-color:#212529;border:none;opacity:0.9;"
	                   onmouseover="this.style.backgroundColor='rgba(255, 255, 255, 0.3)'"  onmouseout="this.style.backgroundColor='#212529'">Bookshareとは</a>
	                </li>
	                <li class="nav-item">
	                  <s:submit class="nav-link button" onclick="goPostListAction();" value="投稿を見る" style="color:white;background-color:#212529;border:none;opacity:0.9;"
