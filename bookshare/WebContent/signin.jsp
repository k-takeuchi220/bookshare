        ...
        <div id="container-form">
          <div class="text-center">
            <h1>無料会員登録</h1>
             ...
             <p>BookShareの<a href="#" onclick="goTermsOfService()">利用規約</a>
            および<a href="#" onclick="goPrivacyPolicy()">プライバシーポリシー</a>に同意の上、会員登録お願い致します。</p>
          ...
          <div class="twitter-box">
	        ...
	        <s:if test="!#session.loginPostErrorMessageList.isEmpty()">
				<div class="error">
				<div class="error-message">
				<s:iterator value="#session.loginPostErrorMessageList"><s:property /><br></s:iterator>
				</div>
				</div>
			</s:if>
...
<div class="form-group">
	...
	<s:textfield class="form-control txt" id="exampleInputUserName" name="userName"  label="名前" placeholder="名前" style="ime-mode: active;">
	</s:textfield>
</div>
...
<div class="form-group">
	...
	<s:textfield class="form-control txt" id="exampleInputEmail" name="email" label="メールアドレス" placeholder="メールアドレス" type="email" style="ime-mode: disabled;">
	</s:textfield>
</div>
...
既にアカウントをお持ちの方は<a href="login.jsp">こちら</a>
</div>
</div>
...
function goPrivacyPolicy(){
	...
	window.open("privacyPolicy.jsp","","width=640,height=480"
	              + ",left=" + w + ",top=" + h);
	}
...
function goTermsOfService(){
   //別窓の左と上の余白を求める
 	 ...
 	 //オプションパラメーターleftとtopに余白の値を指定
 	 window.open("termsOfService.jsp","","width=640,height=480"
              + ",left=" + w + ",top=" + h);
	}
