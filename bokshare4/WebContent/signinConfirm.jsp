      ...
      <div id="main">
        <div  id="container-confirm">
          ...
          <div id="wrapper-confirm-btn">
            <button type="button" class="btn btn-outline-secondary btn-lg confirm-btn" id="qqqq" onclick='href="location.signin.jsp"'>戻る</button>
            <br>
            <s:submit type="button" class="btn btn-primary btn-lg confirm-btn" id="regist-btn" form="form">会員登録</s:submit>
            <br>
            <button type="button" class="btn btn-outline-secondary" id="btn-mypage" onclick='href="location.index.jsp"'>トップページへ</button>
          </div>
